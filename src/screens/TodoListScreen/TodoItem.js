import { Box, Checkbox, CheckIcon, CloseIcon, HStack, IconButton, InfoIcon, Input, Text, useColorModeValue } from 'native-base';
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {isEdit ? (
          <Input flex={1} backgroundColor={useColorModeValue("gray.100", "gray.900")} fontSize="xl" onChangeText={v => setInputValue(v)} value={inputValue} placeholder="Edit Task" />
        ) : (
